defmodule TznWeb.TypeformWebhookController do
  ...
  def handle(conn, %{"form_response" => %{"answers" => answers}}) do
    ...
    mentee_phone = get_answer_by_field_id(answers, "16e1f32b51b6ab87", "phone_number")
    mentee_email = get_answer_by_field_id(answers, "bb066f78-e17e-4ed3-bc01-e2e08db4fad5", "email")
    ...
    parent1_phone = get_answer_by_field_id(answers, "d905a713-ce18-4ba9-8542-74b33320589d", "phone_number")
    parent1_email = get_answer_by_field_id(answers, "38f065e6-6f63-47c1-aa24-462176de4862", "email")
    ...
    parent2_phone = get_answer_by_field_id(answers, "151597ee-b00d-4634-b0c4-287ba49d06cd", "phone_number")
    parent2_email = get_answer_by_field_id(answers, "ce462e37-19ec-45a9-ab18-55f47c365a9d", "email")
  ...
  def get_answer_by_field_id(answers, field_id, field_type \\ "text") when is_list(answers) and is_binary(field_id) do
    Enum.find(answers, %{}, fn a -> a["field"]["ref"] == field_id end) |> Map.get(field_type, "")
  end
end
