defmodule TznWeb.StrategySessionController do
  ...
  def create(conn, %{"strategy_session" => strategy_session_params}) do
    case Transizion.create_strategy_session(strategy_session_params) do
      {:ok, strategy_session} ->
        ...
        |> redirect(to: Routes.strategy_session_path(conn, :show, strategy_session))
  ...
  def delete(conn, %{"id" => id}) do
    ...
    |> redirect(to: Routes.strategy_session_path(conn, :index))
  end
end
