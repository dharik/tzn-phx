defmodule Tzn.Transizion.StrategySession do
  ...
  def changeset(strategy_session, attrs) do
    strategy_session
    |> cast(attrs, [:published, :date, :notes, :mentor_id, :email_subject, :emailed, :cc_mentee, :pod_id])
    |> validate_required([:published, :date, :notes, :pod_id, :mentor_id, :email_subject, :cc_mentee])
  end
